...
|------|-------------|------|---------|:--------:|
| <a name="input_billing_account"></a> [billing\_account](#input\_billing\_account) | Billing account a project is attached to | `string` | n/a | yes |
| <a name="input_ds_semester"></a> [ds\_semester](#input\_ds\_semester) | Data science semester | `string` | n/a | yes |
| <a name="input_region"></a> [region](#input\_region) | GCP region | `string` | `"europe-west1"` | no |
| <a name="input_user_id"></a> [user\_id](#input\_user\_id) | Data science user id | `number` | n/a | yes |
